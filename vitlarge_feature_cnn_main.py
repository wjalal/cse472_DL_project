...
# Load pre-trained ViT model , vit-large-patch16-224
...
os.makedirs("adni_storage/ADNI_features_large", exist_ok=True)
...
for _, row in tqdm(df.iterrows(), total=len(df), desc="Processing images"):
    ...
    feature_file_path = f"adni_storage/ADNI_features_large/{image_title}_features.npy"

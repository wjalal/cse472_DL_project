...
class AgePredictionCNN(nn.Module):
    def __init__(self, input_shape):
        ...
        self.dropout = nn.Dropout(p=0.1)  # Dropout with 50% probability
...
load_saved = "last" # "last, "best"
if load_saved != "none":
    # Load the checkpoint
    with open(f"{load_saved}_model_with_metadata.pkl", "rb") as f:
...
for epoch in range(start_epoch, epochs):
    ...
    with open("last_model_with_metadata.pkl", "wb") as f:
    ...
    if val_loss < best_loss:
        ...
        with open("best_model_with_metadata.pkl", "wb") as f:
            pickle.dump(checkpoint, f)